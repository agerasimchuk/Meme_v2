...
//print(memedImage)
var meme =  MemeClass.Meme( topText: topTextField.text!, bottomText: bottomTextField.text!, originalImage: imageViewPicker.image, memedImage: generateMemedImage())
...
//present Activity Vew Controller
